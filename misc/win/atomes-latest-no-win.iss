...
Root: HKLM; Subkey: "Software\IPCMS\ATOMES\1.3.1"; ValueType: string; ValueName: "Path"; ValueData: "{app}\bin"; Flags: uninsdeletekey
...
Root: HKA; Subkey: "Software\IPCMS\ATOMES\1.3.1"; ValueType: string; ValueName: "Path"; ValueData: "{app}\bin"; Flags: uninsdeletekey
